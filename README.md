...
- `references/` contains original downloaded source material.
- `Econlib/` contains Lean 4 files organized by economics area.
...
1. Understand the existing Lean 4 vNM and AMM formalizations.
